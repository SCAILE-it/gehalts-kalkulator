      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl shadow p-4 md:p-6">
            <h2 className="font-semibold mb-4">Eingaben</h2>
          ...
          <div className="bg-white rounded-2xl shadow p-4 md:p-6 flex flex-col justify-between">
            <div>
              <h2 className="font-semibold mb-4">Ergebnis</h2>
              {contract === "perm" ? (
                <div className="space-y-2">
                  <div className="text-sm text-gray-600">Zielgehalt (Brutto/Jahr)</div>
                  <div className="text-3xl font-bold">
                    {formatCurrency(result.median, country)}
                  </div>
                  <div className="text-sm text-gray-600">Orientierungsbereich (25.–75. Perzentil)</div>
                ...
                <div className="space-y-2">
                  <div className="text-sm text-gray-600">Ziel-Tagessatz (Freelance)</div>
                  <div className="text-3xl font-bold">{formatCurrency(result.dayRate, country)}</div>
                  <div className="text-sm text-gray-600">(entspricht Median-Festanstellung: {formatCurrency(result.median, country)})</div>
                </div>
              )}

              <div className="mt-6">
                <h3 className="font-semibold mb-2">Zusammenfassung</h3>
                <pre className="bg-gray-100 rounded-xl p-3 text-sm whitespace-pre-wrap">{summaryText}</pre>
              </div>
            </div>
